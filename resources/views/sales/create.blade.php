                ...
                <form action="/sales" method="post">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6 col-12">
                            ...
                            <select class="form-control" type="" name="type" id="type" value=""
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <select class="form-control" type="" name="status" id="status" value=""
                                placeholder="Pilih Status Pembayaran" required>
